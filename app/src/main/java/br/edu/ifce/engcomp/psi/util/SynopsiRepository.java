 ...
 */
public class SynopsiRepository {

    public static String gt1 = "A Guerra dos Tronos - Quando Eddard Stark, lorde do castelo de Winterfell,"+
            " aceita a prestigiada posição de Mão do Rei oferecida pelo velho amigo, o rei Robert Baratheon,"+
            " não desconfia que sua vida está prestes a ruir em sucessivas tragédias. Sabe-se que Lorde Stark"+
            " aceitou a proposta porque desconfia que o dono anterior do título fora envenenado pela manipuladora"+
    ...
    public static String umabreve = "Uma Breve História do Tempo - Uma das mentes mais geniais do mundo moderno, Stephen Hawking"+
            ...
            " Ele é infinito? E o tempo? Sempre existiu, ou houve um começo e haverá um fim? Existem outras dimensões além das"+
    ...
    public static String contato = "Contato com extraterrestres não é sinônimo de homenzinhos verdes desembarcando de"+
            ...
            " fazer repensar toda a nossa concepção da vida e do universo. Em 'Contato', o que está em jogo é o mundo"+
            " tal como o conhecemos. Como quem faz uma aposta, Sagan nos convida a uma viagem pelo buraco negro que é"+
    ...
    public static String ailha = "A Ilha do Conhecimento - Quanto podemos conhecer do mundo? Será que podemos conhecer"+
            ...
            " até que ponto podemos compreender a natureza da realidade? Estas perguntas, e suas consequências surpreendentes,"+
    ...
    public static String farenheit = "Fahrenheit 451 - Escrito após o término da Segunda Guerra Mundial, em 1953,"+
            ...
            " anti-intelectual nazista, mas principalmente o cenário dos anos 1950, revelando sua apreensão numa sociedade"+
            " opressiva e comandada pelo autoritarismo do mundo pós-guerra. Agora, o título de Bradbury, que morreu recentemente,"+
            " em 6 de junho de 2012, ganhou nova edição pela Biblioteca Azul, selo de alta literatura e clássicos da Globo Livros,"+
            " e atualização para a nova ortografia. A singularidade da obra de Bradbury, se comparada a outras distopias,"+
            " como Admirável Mundo Novo, de Aldous Huxley, ou 1984, de George Orwell, é perceber uma forma muito mais sutil"+
            " de totalitarismo, uma que não se liga somente aos regimes que tomaram conta da Europa em meados do século passado."+
            " Trata-se da “indústria cultural, a sociedade de consumo e seu corolário ético – a moral do senso comum”, segundo as"+
            " palavras do jornalista Manuel da Costa Pinto, que assina o prefácio da obra. Graças a esta percepção, Fahrenheit 451"+
            " continua uma narrativa atual, alvo de estudos e reflexões constantes. O livro descreve um governo totalitário, num"+
            " futuro incerto, mas próximo, que proíbe qualquer livro ou tipo de leitura, prevendo que o povo possa ficar instruído"+
            " e se rebelar contra o status quo. Tudo é controlado e as pessoas só têm conhecimento dos fatos por aparelhos de TVs"+
    ...
    public static String onomedovento = "O Nome do Vento - Ninguém sabe ao certo quem é o herói ou o vilão desse fascinante"+
            ...
            " que se esconde sob a identidade de proprietário da hospedaria Marco do Percurso. Da infância numa trupe de artistas"+
            " itinerantes, passando pelos anos vividos numa cidade hostil e pelo esforço para ingressar na escola de magia,"+
            " O nome do vento acompanha a trajetória de Kote e as duas forças que movem sua vida: o desejo de aprender o mistério"+
            " por trás da arte de nomear as coisas e a necessidade de reunir informações sobre o Chandriano - os lendários"+
            " demônios que assassinaram sua família no passado. Quando esses seres do mal reaparecem na cidade, um cronista"+
            " suspeita de que o misterioso Kote seja o personagem principal de diversas histórias que rondam a região e decide"+
    ...
    public static String otemordosabio = "O Temor do Sábio - O temor do sábio dá continuidade à impressionante"+
            ...
            " seus estudos na Universidade por um período, por causa de sua rivalidade com um membro da nobreza"+
            " local, Kvothe é obrigado a tentar a vida em outras paragens. Em busca de um patrocinador para sua"+
            " música, viaja mais de mil quilômetros até Vintas. Lá, é rapidamente envolvido na política da corte."+
            " Enquanto tenta cair nas graças de um nobre poderoso, Kvothe usa sua habilidade de arcanista para"+
            " impedir que ele seja envenenado e lidera um grupo de mercenários pela floresta, a fim de combater"+
            " um bando de ladrões perigosos. Ao longo do caminho, tem um encontro fantástico com Feluriana,"+
            " uma criatura encantada à qual nenhum homem jamais pôde resistir ou sobreviver – até agora. Kvothe"+
    ...
    public static String teoremadefermat = "O Último Teorema de Fermat, como ficou conhecido, tornou-se"+
            ...
            " busca de uma demonstração para um problema aparentemente simples. Várias pessoas tentaram"+
            " demonstrá-lo mais não conseguiram até que surgiu, um professor de Princeton, Andrew Wiles,"+
            " que sonhava em demonstrar o Último Teorema de Fermat desde que o vira pela primeira vez,"+
            " ainda menino, ba biblioteca de sua cidade. Com medo da sucessão de fracassos de seus"+
            " antecessores, durante sete anos publicou artigos sobre outros assuntos, de modo a despistar"+
            " os colegas, enquanto trabalhava em sua obsessão. Em 1993, passados 356 anos desde o desafio"+
            " de Fermat, Wiles assombrou o mundo ao anunciar a demonstração. Mas sua luta ainda não tinha"+
    ...
    public static String poderhabito = "O Poder do Hábito - Durante os últimos dois anos, uma jovem"+
            ...
            " foi promovida. Em um laboratório, neurologistas descobriram que os padrões dentro do cérebro"+
            " dela – ou seja, seus hábitos – foram modificados de maneira fundamental para que todas essas"+
            " mudanças ocorressem. Há duas décadas pesquisando ao lado de psicólogos, sociólogos e publicitários,"+
            " cientistas do cérebro começaram finalmente a entender como os hábitos funcionam – e, mais importante,"+
            " como podem ser transformados. Embora isoladamente pareçam ter pouca importância, com o tempo, têm um"+
            " enorme impacto na saúde, na produtividade, na estabilidade financeira e na felicidade. Com base na"+
            " leitura de centenas de artigos acadêmicos, entrevistas com mais de trezentos cientistas e executivos,"+
            " além de pesquisas realizadas em dezenas de empresas, o repórter investigativo do New York Times Charles"+

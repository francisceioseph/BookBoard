...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table book(_id integer primary key autoincrement, title text not null, author text, publisher text, image blob, numberPage integer, synopsis text)");
